            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <div>
                        ...
                        <div className="mb-10">
                            <a href="#contact" className="btn-primary inline-block px-8 py-4 text-lg animate-pulse">
                                Get Free Consultation
                            </a>
                        </div>

                        <div className="space-y-8">
                            {/* Social Icons - Updated Size & Platforms */}
                            <div className="flex gap-6 mb-8">
                                <a href="#" className="w-16 h-16 bg-primary rounded-xl flex items-center justify-center text-accent border border-white/5 hover:bg-accent hover:text-primary transition-all duration-300 transform hover:scale-110">
                                    {/* WhatsApp */}
